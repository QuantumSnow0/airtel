        ...
        <section id="step-2" ref={step2Ref} className="px-3 py-2">
          <div className="w-full">
            ...
            >
              ...
              {/* Overview & Troubleshooting guides - below submit for visibility */}
              <div className="mt-6 pt-4 border-t border-neutral-700/50">
                ...
                <div className="flex flex-col gap-2">
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-lg bg-neutral-800/60 border border-neutral-700/50 p-3 active:bg-neutral-700/60 transition-colors"
                  >
                    <div className="w-10 h-10 rounded-lg bg-yellow-400/20 border border-yellow-400/30 flex items-center justify-center shrink-0">
                      <svg
                        className="w-5 h-5 text-yellow-400"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-neutral-400 mt-0.5">
                        Learn about the Airtel SmartConnect 5G router and its
                        capabilities.
                      </p>
                    </div>
                    <svg
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-neutral-400 mt-0.5">
                        Common issues and solutions to get your device working
                        perfectly.
                      </p>
                    </div>
                    <svg
